...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-5 md:flex-row m-h-screen bg-gray-100 p-6">
      <div className="w-full md:w-1/4 p-4 bg-white shadow-lg rounded-lg mb-4 md:mb-0">
...
function SocialNetworks() {
  return (
    <div>
      ...
      <div className="mt-4 flex flex-wrap justify-center space-x-4 shadow-lg py-3">
...
function DeleteAccount() {
  return (
    <div>
      ...
      <div className="h-screen pt-6 flex items-start justify-center">
